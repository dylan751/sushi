...
interface Props {
  settings: Settings
  notifications: (NotificationsType & { projectName: string })[]
}
...
const NotificationDropdown = (props: Props) => {
  ...
  const handleMenuItemClick = (projectName: string) => {
    router.replace(getProjectDefaultTab(projectName))
  }
      ...
      >
        ...
        <ScrollWrapper hidden={hidden}>
          {notifications.map((notification, index: number) => (
            <MenuItem key={index} onClick={() => handleMenuItemClick(notification.projectName)}>
