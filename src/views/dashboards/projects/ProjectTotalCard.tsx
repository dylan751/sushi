...
const ScrollWrapper = ({ children }: { children: ReactNode }) => {
  return <Box sx={{ height: '300px', overflowY: 'auto', overflowX: 'hidden' }}>{children}</Box>
}

export interface ProjectTotalCardProps {
  title: string
  type: InvoiceType
...
const ProjectTotalCard = ({ title, type, invoices, total }: ProjectTotalCardProps) => {
