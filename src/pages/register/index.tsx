...
const Register = () => {
  ...
  const registerWithGoogle = (e: MouseEvent<HTMLElement>) => {
    e.preventDefault()
          ...
          <BoxWrapper>
            ...
            <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
              ...
              <FormControl fullWidth>
                <InputLabel htmlFor='auth-register-v2-password' error={Boolean(errors.password)}>
                  Password
                </InputLabel>
                <Controller
                  name='password'
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Button
                  href='/'
                  component={Link}
                  onClick={(e: MouseEvent<HTMLElement>) => registerWithGoogle(e)}
                  sx={{
                    display: 'flex',
                    gap: '8px',
                    background: '#4081ec',
                    '&:hover': { backgroundColor: '#4081ec' }
                  }}
                  variant='contained'
                >
                  <Icon icon='mdi:google' color='#db4437' />
